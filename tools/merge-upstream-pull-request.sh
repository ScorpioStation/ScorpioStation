#!/usr/bin/env bash
# Based on https://github.com/KeplerStation/KeplerStation/blob/master/kepler/tools/merge-upstream-pull-request.sh

# Usage:
# merge-upstream-pull-request.sh $PULL_ID $COMMIT_MSG
...
readonly BASE_PULL_URL="https://api.github.com/repos/ParadiseSS13/Paradise/pulls"
...
if ! git remote | grep ParadiseSS13 > /dev/null; then
   git remote add ParadiseSS13 https://github.com/ParadiseSS13/Paradise.git
fi
