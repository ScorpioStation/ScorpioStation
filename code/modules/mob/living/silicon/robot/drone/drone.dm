...
/mob/living/silicon/robot/drone/New()
	...
	//Some tidying-up.
	flavor_text = "It's a tiny little repair drone. The casing is stamped with an AS logo and the subscript: 'Ark Soft Recursive Repair Systems: Fixing Tomorrow's Problem, Today!'"
	scanner.Grant(src)
	update_icons()
