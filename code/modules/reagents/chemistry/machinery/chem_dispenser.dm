...
/obj/machinery/chem_dispenser/beer
	...
	hack_message = "You disable the 'Ark Soft-Are-Cheap-Bastards' lock, enabling access to very expensive boozes."
	unhack_message = "You re-enable the 'Ark Soft-Are-Cheap-Bastards' lock, hiding access to very expensive boozes."
