...
/obj/item/clothing/accessory/holobadge/attack_self(mob/user)
	...
	if(isliving(user))
		user.visible_message(
			"<span class='warning'>[user] displays [user.p_their()] ArkSoft Internal Security Legal Authorization Badge.\nIt reads: [stored_name], Ark Security.</span>",
			"<span class='warning'>You display your ArkSoft Internal Security Legal Authorization Badge.\nIt reads: [stored_name], Ark Security.</span>")
...
/obj/item/clothing/accessory/holobadge/attack(mob/living/carbon/human/H, mob/living/user)
	if(isliving(user))
		user.visible_message(
			"<span class='warning'>[user] invades [H]'s personal space, thrusting [src] into [H.p_their()] face insistently.</span>",
...
/obj/item/clothing/accessory/lawyers_badge/attack_self(mob/user)
	...
	user.visible_message(
		"<span class='notice'>[user] shows [user.p_their()] attorney's badge.</span>",
