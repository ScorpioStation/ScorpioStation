...
/obj/item/projectile/process()
	...
	time_offset = 0
	var/required_moves = speed > 0 ? round(elapsed_time_deciseconds / speed) : MOVES_HITSCAN			//Would be better if a 0 speed made hitscan but everyone hates those so I can't make it a universal system :<
