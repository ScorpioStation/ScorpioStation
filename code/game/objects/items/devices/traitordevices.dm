...
/obj/item/teleporter/proc/tile_check(turf/T)
	if(istype(T, /turf/open/floor) || istype(T, /turf/open/space) || istype(T, /turf/open/shuttle/floor) || istype(T, /turf/open/shuttle/floor4) || istype(T, /turf/open/shuttle/plating))
		return TRUE
