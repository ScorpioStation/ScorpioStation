...
/obj/item/toy/cards/singlecard
	...
	desc = "a card"
	icon = 'icons/obj/toy.dmi'
	icon_state = "singlecard_down_arksoft"
	w_class = WEIGHT_CLASS_TINY
	var/cardname = null
	var/flipped = 0
	pixel_x = -5
...
/obj/item/toy/plushie/orange_fox/grump/ComponentInitialize()
	...
	"Congrats, you just left a reference with your dirty client and now that thing you edited will never garbage collect properly.", "Is it that time of day, again, for unnecessary adminbus?")
