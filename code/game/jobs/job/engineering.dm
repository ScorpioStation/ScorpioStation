...
/datum/job/engineer
	...
	department_access = list(ACCESS_ATMOSPHERICS, ACCESS_CONSTRUCTION, ACCESS_EMERGENCY_STORAGE, ACCESS_ENGINE, ACCESS_ENGINE_EQUIP, ACCESS_EVA, ACCESS_EXTERNAL_AIRLOCKS, ACCESS_MAINT_TUNNELS, ACCESS_MECHANIC, ACCESS_MINERAL_STOREROOM, ACCESS_MINISAT, ACCESS_RC_ANNOUNCE, ACCESS_TCOMSAT, ACCESS_TECH_STORAGE, ACCESS_TELEPORTER)
