/datum/job/chief_engineer
	...
	req_admin_notify = 1
	department_access = list(ACCESS_ENGINE, ACCESS_ENGINE_EQUIP, ACCESS_TECH_STORAGE, ACCESS_MAINT_TUNNELS,
...
/datum/job/engineer
	...
	department_access = list(ACCESS_ATMOSPHERICS, ACCESS_CE, ACCESS_CONSTRUCTION, ACCESS_EMERGENCY_STORAGE, ACCESS_ENGINE, ACCESS_ENGINE_EQUIP, ACCESS_EVA, ACCESS_EXTERNAL_AIRLOCKS, ACCESS_HEADS, ACCESS_KEYCARD_AUTH, ACCESS_MAINT_TUNNELS, ACCESS_MECHANIC, ACCESS_MINERAL_STOREROOM, ACCESS_MINISAT, ACCESS_RC_ANNOUNCE, ACCESS_SEC_DOORS, ACCESS_TCOMSAT, ACCESS_TECH_STORAGE, ACCESS_TELEPORTER)
