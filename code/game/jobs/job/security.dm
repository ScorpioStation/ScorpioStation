/datum/job/hos
	...
	req_admin_notify = 1
	department_access = list(ACCESS_SECURITY, ACCESS_SEC_DOORS, ACCESS_BRIG, ACCESS_ARMORY, ACCESS_COURT,
...
/datum/job/warden
	...
	department_access = list(ACCESS_ALL_PERSONAL_LOCKERS, ACCESS_ARMORY, ACCESS_BRIG, ACCESS_CONSTRUCTION, ACCESS_COURT, ACCESS_ENGINE, ACCESS_FORENSICS_LOCKERS, ACCESS_GATEWAY, ACCESS_HEADS, ACCESS_HOS, ACCESS_KEYCARD_AUTH, ACCESS_MAILSORTING, ACCESS_MAINT_TUNNELS, ACCESS_MEDICAL, ACCESS_MINING, ACCESS_MORGUE, ACCESS_PILOT, ACCESS_RC_ANNOUNCE, ACCESS_RESEARCH, ACCESS_SEC_DOORS, ACCESS_SECURITY, ACCESS_WEAPONS)
...
/datum/job/detective
	...
	department_access = list(ACCESS_ALL_PERSONAL_LOCKERS, ACCESS_ARMORY, ACCESS_BRIG, ACCESS_CONSTRUCTION, ACCESS_COURT, ACCESS_ENGINE, ACCESS_FORENSICS_LOCKERS, ACCESS_GATEWAY, ACCESS_MAILSORTING, ACCESS_MAINT_TUNNELS, ACCESS_MEDICAL, ACCESS_MINING, ACCESS_MORGUE, ACCESS_PILOT, ACCESS_RC_ANNOUNCE, ACCESS_RESEARCH, ACCESS_SEC_DOORS, ACCESS_SECURITY, ACCESS_WEAPONS)
...
/datum/job/brigdoc
	...
	department_head = list("Head of Security")
	selection_color = "#ffeeee"
	department_access = list(ACCESS_ALL_PERSONAL_LOCKERS, ACCESS_ARMORY, ACCESS_BRIG, ACCESS_CONSTRUCTION, ACCESS_COURT, ACCESS_ENGINE, ACCESS_FORENSICS_LOCKERS, ACCESS_GATEWAY, ACCESS_MAILSORTING, ACCESS_MAINT_TUNNELS, ACCESS_MEDICAL, ACCESS_MINING, ACCESS_MORGUE, ACCESS_PILOT, ACCESS_RC_ANNOUNCE, ACCESS_RESEARCH, ACCESS_SEC_DOORS, ACCESS_SECURITY, ACCESS_WEAPONS, ACCESS_MEDICAL, ACCESS_MORGUE, ACCESS_SURGERY, ACCESS_CHEMISTRY, ACCESS_VIROLOGY, ACCESS_GENETICS)
...
/datum/job/pilot
	...
	department_head = list("Head of Security")
	selection_color = "#ffeeee"
	department_access = list(ACCESS_ALL_PERSONAL_LOCKERS, ACCESS_ARMORY, ACCESS_BRIG, ACCESS_CONSTRUCTION, ACCESS_COURT, ACCESS_ENGINE, ACCESS_EXTERNAL_AIRLOCKS, ACCESS_FORENSICS_LOCKERS, ACCESS_GATEWAY, ACCESS_MAILSORTING, ACCESS_MAINT_TUNNELS, ACCESS_MEDICAL, ACCESS_MINING, ACCESS_MORGUE, ACCESS_PILOT, ACCESS_RC_ANNOUNCE, ACCESS_RESEARCH, ACCESS_SEC_DOORS, ACCESS_SECURITY, ACCESS_WEAPONS)
