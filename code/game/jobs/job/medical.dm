/datum/job/cmo
	...
	req_admin_notify = 1
	department_access = list(ACCESS_MEDICAL, ACCESS_MORGUE, ACCESS_GENETICS, ACCESS_HEADS,
...
/datum/job/doctor
	...
	department_access = list(ACCESS_CHEMISTRY, ACCESS_CMO, ACCESS_GENETICS, ACCESS_HEADS, ACCESS_KEYCARD_AUTH, ACCESS_MAINT_TUNNELS, ACCESS_MEDICAL, ACCESS_MINERAL_STOREROOM, ACCESS_MORGUE, ACCESS_PARAMEDIC, ACCESS_PSYCHIATRIST, ACCESS_RC_ANNOUNCE, ACCESS_SEC_DOORS, ACCESS_SURGERY, ACCESS_VIROLOGY)
...
/datum/job/geneticist
	...
	minimal_access = list(ACCESS_MEDICAL, ACCESS_MORGUE, ACCESS_GENETICS, ACCESS_MAINT_TUNNELS)
	minimal_player_age = 3
	exp_requirements = 180
	exp_type = EXP_TYPE_CREW
