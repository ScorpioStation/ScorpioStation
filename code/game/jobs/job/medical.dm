...
/datum/job/doctor
	...
	department_access = list(ACCESS_CHEMISTRY, ACCESS_GENETICS, ACCESS_MAINT_TUNNELS, ACCESS_MEDICAL, ACCESS_MINERAL_STOREROOM, ACCESS_MORGUE, ACCESS_PARAMEDIC, ACCESS_PSYCHIATRIST, ACCESS_RC_ANNOUNCE, ACCESS_SURGERY, ACCESS_VIROLOGY)
