/datum/job/rd
	...
	req_admin_notify = 1
	department_access = list(ACCESS_RD, ACCESS_HEADS, ACCESS_TOX, ACCESS_MORGUE,
...
/datum/job/scientist
	...
	department_access = list(ACCESS_AI_UPLOAD, ACCESS_GATEWAY, ACCESS_HEADS, ACCESS_KEYCARD_AUTH, ACCESS_MAINT_TUNNELS, ACCESS_MINERAL_STOREROOM, ACCESS_MINISAT, ACCESS_MORGUE, ACCESS_NETWORK, ACCESS_RC_ANNOUNCE, ACCESS_RD, ACCESS_RESEARCH, ACCESS_ROBOTICS, ACCESS_SEC_DOORS, ACCESS_TCOMSAT, ACCESS_TECH_STORAGE, ACCESS_TELEPORTER, ACCESS_TOX, ACCESS_TOX_STORAGE, ACCESS_XENOARCH, ACCESS_XENOBIOLOGY)
