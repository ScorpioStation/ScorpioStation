...
/datum/job/scientist
	...
	department_access = list(ACCESS_GATEWAY, ACCESS_MAINT_TUNNELS, ACCESS_MINERAL_STOREROOM, ACCESS_MINISAT, ACCESS_MORGUE, ACCESS_NETWORK, ACCESS_RC_ANNOUNCE, ACCESS_RESEARCH, ACCESS_ROBOTICS, ACCESS_TCOMSAT, ACCESS_TECH_STORAGE, ACCESS_TELEPORTER, ACCESS_TOX, ACCESS_TOX_STORAGE, ACCESS_XENOARCH, ACCESS_XENOBIOLOGY)
