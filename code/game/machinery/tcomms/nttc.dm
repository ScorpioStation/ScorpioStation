...
/datum/nttc_configuration
	...
	var/all_jobs = list(
		...
		"Ark Soft Navy Officer" = "dsquadradio",
	...
	var/list/heads = list("Captain", "Head of Personnel", "Ark Soft Representative", "Nanotrasen Representative", "Blueshield", "Chief Engineer", "Chief Medical Officer", "Research Director", "Head of Security", "Magistrate", "AI")
	/// List of ERT jobs
