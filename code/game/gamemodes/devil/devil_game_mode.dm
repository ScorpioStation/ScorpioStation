/datum/game_mode/devil
	name = "devil"
	config_tag = "devil"
	protected_jobs = list("Security Officer", "Warden", "Detective", "Ark Soft Representative", "Security Pod Pilot", "Magistrate",
						 "Internal Affairs Agent", "Librarian", "Chaplain", "Head of Security", "Captain",  "Brig Physician",
						 "Ark Soft Navy Officer", "Special Operations Officer", "AI", "Cyborg")
	required_players = 2
	required_enemies = 1
