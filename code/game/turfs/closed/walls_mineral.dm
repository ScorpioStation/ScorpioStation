...
/turf/closed/wall/mineral/uranium/attackby(obj/item/W as obj, mob/user as mob, params)
	radiate()
	..()
...
/turf/closed/wall/mineral/plasma/attackby(obj/item/W as obj, mob/user as mob)
...
/turf/closed/wall/mineral/plasma/welder_act(mob/user, obj/item/I)
	if(I.tool_enabled)
...
/turf/closed/wall/mineral/alien
	name = "alien wall"
	desc = "A strange-looking alien wall."
	icon = 'icons/turf/walls/plasma_wall.dmi'
	icon_state = "plasma"
	sheet_type = /obj/item/stack/sheet/mineral/abductor
	canSmoothWith = list(/turf/closed/wall/mineral/alien, /obj/structure/falsewall/alien)
...
/turf/closed/wall/mineral/titanium/survival/pod
	canSmoothWith = list(/turf/closed/wall/mineral/titanium/survival, /obj/machinery/door/airlock/survival_pod)

//undeconstructable type for derelict
//these walls are undeconstructable/unthermitable
/turf/closed/wall/mineral/titanium/nodecon
	name = "russian wall"
	desc = "Like regular titanium, but able to deflect capitalist aggressors."

/turf/closed/wall/mineral/titanium/nodecon/tileblend
	fixed_underlay = list("icon"='icons/turf/floors.dmi', "icon_state"="darkredfull")

/turf/closed/wall/mineral/titanium/nodecon/nodiagonal
	smooth = SMOOTH_MORE
	icon_state = "map-shuttle_nd"

/turf/closed/wall/mineral/titanium/nodecon/nosmooth
	smooth = SMOOTH_FALSE
	icon = 'icons/turf/shuttle.dmi'
	icon_state = "wall"

//properties for derelict sub-type to prevent said deconstruction/thermiting
/turf/closed/wall/mineral/titanium/nodecon/try_decon(obj/item/I, mob/user, params)
	return

/turf/closed/wall/mineral/titanium/nodecon/thermitemelt(mob/user as mob, speed)
	return

/turf/closed/wall/mineral/titanium/nodecon/burn_down()
	return

/turf/closed/wall/mineral/titanium/nodecon/welder_act()
	return
...
/turf/closed/wall/mineral/plastitanium/coated
	name = "coated wall"
	max_temperature = INFINITY
	icon_state = "map-shuttle_nd"
	smooth = SMOOTH_MORE

/turf/closed/wall/mineral/plastitanium/coated/Initialize(mapload)
	. = ..()
...
/turf/closed/wall/mineral/plastitanium/explosive/proc/self_destruct()
