...
//	var/enable_authentication = 0		// goon authentication
	...
	// attempt to synchronize the autotransfer to the wall clock
	var/autotransfer_wall_clock = FALSE

	// require this many connected players before census bot will announce
	var/census_bot_minimum = 2
