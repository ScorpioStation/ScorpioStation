...
/datum/controller/subsystem/tickets/proc/autoRespond(N)
	...
	var/response_phrases = list("Thanks" = "Thank you, and have a great shift!",
		"Handling It" = "The issue is being looked into, thank you for bringing it to our attention.",
		...
		"Happens Again" = "Thank you, please let us know if it continues to happen.",
		...
		"IC Issue" = "This is an In Character (IC) issue and will not be handled by admins. You could speak to Security, Internal Affairs, a Departmental Head, Ark Soft Representetive, or any other relevant authority currently on station.",
		"Reject" = "Reject",
		"Man Up" = "Man Up",
