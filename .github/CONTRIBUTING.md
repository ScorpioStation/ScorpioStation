...
## Introduction
This is the contribution guide for Scorpio Station. These guidelines apply to
...
### No duplicated code
Copying code from one place to another may be suitable for small, short-time projects, but Scorpio is a long-term project and highly discourages this.
...
### Player Output
Due to the use of "Goonchat", Scorpio requires a special syntax for outputting text messages to players. Instead of `mob/client/world << "message"`,
