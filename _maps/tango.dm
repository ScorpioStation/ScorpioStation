...
Small changes to Delta by Iren for Scorpio
*/

#if !defined(USING_MAP_DATUM)
	#include "map_files\generic\centcomm.dmm"
	#include "map_files\tango\tango.dmm"
...
DECLARE_LEVEL(MINING, SELFLOOPING, list(ORE_LEVEL, REACHABLE, STATION_CONTACT, HAS_WEATHER, AI_OK)))
	...
	#define USING_MAP_DATUM /datum/map/tango

#elif !defined(MAP_OVERRIDE)

	#warn a map has already been included, ignoring Tango.
